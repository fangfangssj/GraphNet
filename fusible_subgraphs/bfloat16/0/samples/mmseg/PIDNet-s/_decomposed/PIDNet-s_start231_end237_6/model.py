...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3, in_4, in_5, in_6, in_7):
        ...
        tmp_6 = torch.nn.functional.interpolate(conv2d, size = (8, 8), mode = 'bilinear', align_corners = False);  conv2d = None
        tmp_7 = tmp_6 + in_6;  tmp_6 = in_6 = None
        tmp_8 = torch.nn.functional.adaptive_avg_pool2d(in_5, (1, 1));  in_5 = None
