...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3, in_4, in_5):
        tmp_4 = torch.nn.functional.max_pool2d(in_5, 2, 2, 0, 1, ceil_mode = False, return_indices = False);  in_5 = None
        tmp_5 = torch.nn.functional.interpolate(tmp_4, (128, 128), None, 'bilinear', False);  tmp_4 = None
        tmp_6 = torch.cat([in_4, tmp_5], 1);  in_4 = tmp_5 = None
