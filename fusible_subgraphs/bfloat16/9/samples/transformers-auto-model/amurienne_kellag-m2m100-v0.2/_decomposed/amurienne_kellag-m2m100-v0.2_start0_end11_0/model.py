...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor):
        tmp_1 = torch.arange(0, 15, device = device(type='cuda', index=0))
        tmp_2 = torch.full((15, 16), fill_value = -3.4028234663852886e+38, dtype = torch.float32, device = device(type='cuda', index=0))
        tmp_3 = torch.triu(tmp_2, diagonal = 1);  tmp_2 = None
        tmp_4 = torch.arange(16, device = device(type='cuda', index=0))
        ...
        tmp_11 = tmp_10.expand(1, 1, 15, 15);  tmp_10 = None
        return (tmp_9, tmp_11)
