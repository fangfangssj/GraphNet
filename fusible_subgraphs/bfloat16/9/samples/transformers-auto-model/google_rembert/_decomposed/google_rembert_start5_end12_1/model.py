...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor, in_7 : torch.Tensor):
        ...
        tmp_12 = torch.nn.functional.layer_norm(tmp_11, (256,), in_2, in_1, 1e-12);  tmp_11 = in_2 = in_1 = None
        tmp_13 = torch.nn.functional.dropout(tmp_12, 0, False, False);  tmp_12 = None
        return (tmp_13,)
