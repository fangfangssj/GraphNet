...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3, in_4, in_5, in_6, in_7):
        ...
        tmp_16 = torch.nn.functional.layer_norm(tmp_15, (16,), in_3, in_2, 1e-05);  tmp_15 = in_3 = in_2 = None
        tmp_17 = torch.nn.functional.dropout(tmp_16, p = 0.1, training = False);  tmp_16 = None
        tmp_18 = torch.nn.functional.layer_norm(tmp_17, (16,), in_5, in_4, 1e-05);  in_5 = in_4 = None
