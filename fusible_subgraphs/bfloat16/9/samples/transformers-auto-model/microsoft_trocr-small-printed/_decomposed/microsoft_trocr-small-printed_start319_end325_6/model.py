...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3, in_4, in_5, in_6):
        ...
        tmp_6 = torch.nn.functional.layer_norm(tmp_5, (384,), in_2, in_1, 1e-12);  tmp_5 = in_2 = in_1 = None
        tmp_7 = tmp_6[(slice(None, None, None), 0)]
        linear = torch.nn.functional.linear(tmp_7, in_4, in_3);  tmp_7 = in_4 = in_3 = None
