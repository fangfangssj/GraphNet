...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor, in_7 : torch.Tensor, in_8 : torch.Tensor):
        conv2d = torch.conv2d(in_8, in_1, None, (32, 32), (0, 0), (1, 1), 1);  in_8 = in_1 = None
        ...
        tmp_15 = torch.nn.functional.layer_norm(tmp_14, (768,), in_7, in_6, 1e-05);  tmp_14 = in_7 = in_6 = None
        tmp_16 = torch.nn.functional.layer_norm(tmp_15, (768,), in_5, in_4, 1e-05);  in_5 = in_4 = None
