...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3):
        ...
        tmp_4 = torch.nn.functional.pad(tmp_3, [0, 19], 'constant', None);  tmp_3 = None
        tmp_5 = tmp_4.reshape(-1, 5, 23);  tmp_4 = None
        tmp_6 = tmp_5[(slice(None, None, None), slice(None, 4, None), slice(11, None, None))];  tmp_5 = None
        tmp_7 = tmp_6.reshape(32, 4, 1, 4, 12);  tmp_6 = None
        tmp_8 = tmp_7.expand(-1, -1, 12, -1, -1);  tmp_7 = None
        tmp_9 = tmp_8.permute((0, 3, 1, 4, 2));  tmp_8 = None
        tmp_10 = tmp_9 + in_2;  tmp_9 = in_2 = None
        tmp_11 = tmp_10.reshape(8, 4, 16, -1);  tmp_10 = None
