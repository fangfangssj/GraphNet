...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor, in_7 : torch.Tensor):
        ...
        tmp_15 = torch.nn.functional.layer_norm(tmp_14, (1664,), in_3, in_2, 1e-05);  tmp_14 = in_3 = in_2 = None
        tmp_16 = torch.nn.functional.layer_norm(tmp_15, (1664,), in_1, in_0, 1e-05);  in_1 = in_0 = None
