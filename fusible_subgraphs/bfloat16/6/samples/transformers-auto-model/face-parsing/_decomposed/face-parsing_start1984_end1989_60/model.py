...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor):
        ...
        tmp_9 = torch.nn.functional.layer_norm(tmp_8, (512,), in_3, in_2, 1e-05);  tmp_8 = in_3 = in_2 = None
        tmp_10 = torch.nn.functional.layer_norm(tmp_9, (512,), in_1, in_0, 1e-05);  in_1 = in_0 = None
        return (tmp_9, tmp_10)
