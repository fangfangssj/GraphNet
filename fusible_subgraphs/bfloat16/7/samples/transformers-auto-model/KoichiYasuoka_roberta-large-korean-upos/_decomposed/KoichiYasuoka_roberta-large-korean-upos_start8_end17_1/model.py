...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor, in_7 : torch.Tensor, in_8 : torch.Tensor):
        tmp_8 = torch.nn.functional.embedding(in_1, in_6, 1, None, 2.0, False, False);  in_1 = in_6 = None
        ...
        tmp_11 = torch.nn.functional.embedding(in_8, in_4, 1, None, 2.0, False, False);  in_8 = in_4 = None
        tmp_10 += tmp_11;  tmp_12 = tmp_10;  tmp_10 = tmp_11 = None
        tmp_13 = torch.nn.functional.layer_norm(tmp_12, (1024,), in_3, in_2, 1e-05);  tmp_12 = in_3 = in_2 = None
        ...
        tmp_16 = tmp_15.expand(64, 1, 128, 128);  tmp_15 = None
