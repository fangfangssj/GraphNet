...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor, in_7 : torch.Tensor, in_8 : torch.Tensor):
        tmp_8 = torch.nn.functional.embedding(in_1, in_6, None, None, 2.0, False, False);  in_1 = in_6 = None
        ...
        tmp_13 = torch.nn.functional.layer_norm(tmp_12, (768,), in_3, in_2, 1e-12);  tmp_12 = in_3 = in_2 = None
        tmp_14 = torch.nn.functional.dropout(tmp_13, 0.3, False, False);  tmp_13 = None
