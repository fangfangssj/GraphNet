...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor):
        ...
        tmp_8 = tmp_7.view(1, 64, 32, 24);  tmp_7 = None
        tmp_9 = tmp_8.view(1, 64, -1);  tmp_8 = None
        tmp_10 = tmp_9.permute(0, 2, 1);  tmp_9 = None
        tmp_11 = torch.nn.functional.layer_norm(tmp_10, (64,), in_1, in_0, 1e-06);  in_1 = in_0 = None
        tmp_12 = tmp_11.view(1, 32, 24, 64);  tmp_11 = None
