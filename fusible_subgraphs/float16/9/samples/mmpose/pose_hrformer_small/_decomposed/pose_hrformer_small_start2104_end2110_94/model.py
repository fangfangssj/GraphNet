...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor):
        ...
        tmp_4 = tmp_3.reshape(1, 2, 1, 7, 7, 256);  tmp_3 = None
        tmp_5 = tmp_4.permute(0, 1, 3, 2, 4, 5);  tmp_4 = None
        tmp_6 = tmp_5.reshape(1, 14, 7, 256);  tmp_5 = None
        tmp_7 = tmp_6[(slice(None, None, None), slice(3, 11, None), slice(0, 6, None))];  tmp_6 = None
        return (tmp_7,)
