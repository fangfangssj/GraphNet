...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor):
        tmp_3 = torch.nn.functional.embedding(in_3, in_2, 61870, None, 2.0, False, False);  in_3 = in_2 = None
        tmp_4 = tmp_3 * 32.0;  tmp_3 = None
        tmp_5 = torch.arange(0, 42, dtype = torch.int64, device = device(type='cuda'))
        ...
        tmp_10 = tmp_9.expand(1, 1, 42, 42);  tmp_9 = None
        return (tmp_10, tmp_8)
