...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3, in_4):
        ...
        tmp_3 = in_2.view(1, -1, 8, 32);  in_2 = None
        tmp_4 = tmp_3.transpose(1, 2);  tmp_3 = None
        tmp_5 = linear.view(1, -1, 8, 32);  linear = None
        tmp_6 = tmp_5.transpose(1, 2);  tmp_5 = None
        tmp_7 = in_3.view(1, 1, 8, 32);  in_3 = None
        tmp_8 = tmp_7.transpose(1, 2);  tmp_7 = None
        tmp_9 = tmp_8.reshape(8, -1, 32);  tmp_8 = None
        tmp_10 = tmp_4.reshape(8, -1, 32);  tmp_4 = None
        tmp_11 = tmp_6.reshape(8, -1, 32);  tmp_6 = None
