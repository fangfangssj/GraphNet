...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor):
        ...
        tmp_6 *= -3.4028234663852886e+38;  tmp_7 = tmp_6;  tmp_6 = None
        tmp_8 = tmp_7.unsqueeze(1);  tmp_7 = None
        tmp_9 = tmp_8.unsqueeze(1);  tmp_8 = None
        tmp_10 = torch.nn.functional.embedding(in_0, in_4, 1, None, 2.0, False, False);  in_0 = in_4 = None
        ...
        tmp_13 += 2;  tmp_14 = tmp_13;  tmp_13 = None
        tmp_15 = torch.nn.functional.embedding(tmp_14, in_3, 1, None, 2.0, False, False);  tmp_14 = in_3 = None
        tmp_16 = tmp_10 + tmp_15;  tmp_10 = tmp_15 = None
        tmp_17 = torch.nn.functional.layer_norm(tmp_16, (768,), in_2, in_1, 1e-05);  tmp_16 = in_2 = in_1 = None
