...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor, in_3 : torch.Tensor, in_4 : torch.Tensor, in_5 : torch.Tensor, in_6 : torch.Tensor):
        conv2d = torch.conv2d(in_6, in_3, in_2, (14, 14), (0, 0), (1, 1), 1);  in_6 = in_3 = in_2 = None
        ...
        tmp_14 = torch.nn.functional.layer_norm(tmp_13, (1024,), in_1, in_0, 1e-06);  in_1 = in_0 = None
