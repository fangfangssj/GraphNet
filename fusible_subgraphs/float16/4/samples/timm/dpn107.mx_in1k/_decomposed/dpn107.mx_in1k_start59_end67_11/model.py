...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1, in_2, in_3, in_4, in_5, in_6, in_7):
        ...
        tmp_6 = conv2d[(slice(None, None, None), slice(None, 256, None), slice(None, None, None), slice(None, None, None))]
        tmp_7 = conv2d[(slice(None, None, None), slice(256, None, None), slice(None, None, None), slice(None, None, None))];  conv2d = None
