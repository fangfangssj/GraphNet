...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0 : torch.Tensor, in_1 : torch.Tensor, in_2 : torch.Tensor):
        ...
        tmp_6 = tmp_3.to(dtype = torch.bfloat16);  tmp_3 = None
        tmp_7 = tmp_5.to(dtype = torch.bfloat16);  tmp_5 = None
