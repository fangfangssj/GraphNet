...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3, in_4, in_5, in_6, in_7):
        ...
        tmp_0 = None
        tmp_6 = tmp_5[slice(None, None, None), slice(None, 2048, None), slice(None, None, None), slice(None, None, None)]
        tmp_7 = tmp_5[slice(None, None, None), slice(2048, None, None), slice(None, None, None), slice(None, None, None)]
        tmp_5 = None
        tmp_8 = in_6 + tmp_6
        tmp_6 = None
        ...
        tmp_10 = tmp_1 = tmp_2 = tmp_4 = tmp_3 = None
        tmp_12 = torch.nn.functional.relu(tmp_11, inplace=False)
        tmp_11 = None
        tmp_13 = torch.nn.functional.adaptive_avg_pool2d(tmp_12, 1)
        tmp_12 = None
        return (tmp_13,)