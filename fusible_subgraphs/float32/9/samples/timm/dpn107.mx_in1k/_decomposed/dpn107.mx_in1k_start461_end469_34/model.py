...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3, in_4, in_5, in_6, in_7):
        ...
        tmp_0 = None
        tmp_6 = tmp_5[slice(None, None, None), slice(None, 1024, None), slice(None, None, None), slice(None, None, None)]
        tmp_7 = tmp_5[slice(None, None, None), slice(1024, None, None), slice(None, None, None), slice(None, None, None)]
        tmp_5 = None
        tmp_8 = in_6 + tmp_6
        tmp_6 = None
