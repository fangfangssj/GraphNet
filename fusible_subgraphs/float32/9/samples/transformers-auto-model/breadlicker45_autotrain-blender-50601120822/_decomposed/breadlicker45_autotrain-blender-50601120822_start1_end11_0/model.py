...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1):
        tmp_0 = in_0
        tmp_1 = torch.full((15, 16), fill_value=-3.4028234663852886e+38, dtype=torch.float32, device=device(type='cuda', index=0))
        tmp_2 = torch.triu(tmp_1, diagonal=1)
        tmp_1 = None
        tmp_3 = torch.arange(16, device=device(type='cuda', index=0))
