...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3):
        tmp_0 = in_0
        tmp_1 = in_1
        tmp_2 = torch.nn.functional.layer_norm(in_3, (16,), tmp_1, tmp_0, 1e-05)
        tmp_1 = tmp_0 = None
        tmp_3 = in_2 + tmp_2
        tmp_2 = None
        tmp_4 = tmp_3.view(1, 16, 16, 16)
        tmp_3 = None
        ...
        tmp_8 = tmp_4[slice(None, None, None), slice(1, None, 2), slice(1, None, 2), slice(None, None, None)]
        tmp_4 = None
