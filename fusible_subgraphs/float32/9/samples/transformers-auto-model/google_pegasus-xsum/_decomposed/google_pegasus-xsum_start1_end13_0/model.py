...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3, in_4):
        ...
        tmp_5 = torch.triu(tmp_4, diagonal=1)
        tmp_4 = None
        ...
        tmp_10 = None
        tmp_12 = torch.nn.functional.embedding(in_4, tmp_1, None, None, 2.0, False, False)
        tmp_1 = None
        tmp_13 = tmp_0 + tmp_12
        tmp_0 = tmp_12 = None
        tmp_14 = torch.nn.functional.dropout(tmp_13, p=0.1, training=False)
        tmp_13 = None
        tmp_15 = torch.nn.functional.layer_norm(tmp_14, (1024,), tmp_3, tmp_2, 1e-05)
        tmp_3 = tmp_2 = None
