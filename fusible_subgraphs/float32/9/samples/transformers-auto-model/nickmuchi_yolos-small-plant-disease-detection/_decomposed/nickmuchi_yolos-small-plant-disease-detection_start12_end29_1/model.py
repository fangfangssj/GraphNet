...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3, in_4):
        tmp_0 = in_0
        tmp_1 = torch.nn.functional.interpolate(in_4, size=(32, 32), mode='bicubic', align_corners=False)
        ...
        tmp_10 = None
        tmp_12 = tmp_11.view(11, 384, 32, 54)
        tmp_11 = None
        tmp_13 = torch.nn.functional.interpolate(tmp_12, size=(32, 32), mode='bicubic', align_corners=False)
        tmp_12 = None
        ...
        tmp_15 = None
        tmp_17 = tmp_16.view(11, 1, 1024, 384)
        tmp_16 = None
