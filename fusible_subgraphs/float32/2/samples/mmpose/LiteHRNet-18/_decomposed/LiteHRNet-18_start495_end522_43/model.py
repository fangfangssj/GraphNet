...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3, in_4, in_5, in_6, in_7, in_8):
        ...
        tmp_4 = None
        tmp_8 = tmp_5.view(8, 2, 20, 64, 48)
        tmp_5 = None
        tmp_9 = torch.transpose(tmp_8, 1, 2)
        tmp_8 = None
        tmp_10 = tmp_9.contiguous()
        tmp_9 = None
        tmp_11 = tmp_10.view(8, 40, 64, 48)
        tmp_10 = None
        tmp_12 = tmp_6.view(8, 2, 40, 32, 24)
        tmp_6 = None
        tmp_13 = torch.transpose(tmp_12, 1, 2)
        tmp_12 = None
        tmp_14 = tmp_13.contiguous()
        tmp_13 = None
        tmp_15 = tmp_14.view(8, 80, 32, 24)
        tmp_14 = None
        tmp_16 = tmp_7.view(8, 2, 80, 16, 12)
        tmp_7 = None
        tmp_17 = torch.transpose(tmp_16, 1, 2)
        tmp_16 = None
        tmp_18 = tmp_17.contiguous()
        tmp_17 = None
        tmp_19 = tmp_18.view(8, 160, 16, 12)
        tmp_18 = None
