...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, in_0, in_1, in_2, in_3, in_4, in_5, in_6, in_7, in_8, in_9, in_10):
        ...
        tmp_4 = None
        tmp_9 = tmp_5.view(4, 2, 20, 64, 48)
        tmp_5 = None
        tmp_10 = torch.transpose(tmp_9, 1, 2)
        tmp_9 = None
        tmp_11 = tmp_10.contiguous()
        tmp_10 = None
        tmp_12 = tmp_11.view(4, 40, 64, 48)
        tmp_11 = None
        tmp_13 = tmp_6.view(4, 2, 40, 32, 24)
        tmp_6 = None
        tmp_14 = torch.transpose(tmp_13, 1, 2)
        tmp_13 = None
        tmp_15 = tmp_14.contiguous()
        tmp_14 = None
        tmp_16 = tmp_15.view(4, 80, 32, 24)
        tmp_15 = None
        tmp_17 = tmp_7.view(4, 2, 80, 16, 12)
        tmp_7 = None
        tmp_18 = torch.transpose(tmp_17, 1, 2)
        tmp_17 = None
        tmp_19 = tmp_18.contiguous()
        tmp_18 = None
        tmp_20 = tmp_19.view(4, 160, 16, 12)
        tmp_19 = None
        tmp_21 = tmp_8.view(4, 2, 160, 8, 6)
        tmp_8 = None
        tmp_22 = torch.transpose(tmp_21, 1, 2)
        tmp_21 = None
        tmp_23 = tmp_22.contiguous()
        tmp_22 = None
        tmp_24 = tmp_23.view(4, 320, 8, 6)
        tmp_23 = None
        tmp_12 += tmp_12
        tmp_25 = tmp_12
        tmp_12 = None
